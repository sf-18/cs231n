...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        h0, c0 = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        h1, c1 = affine_relu_forward(h0, W2, b2)
        scores, c2 = affine_forward(h1, W3, b3)
        ...
        grads['b2'] = db
        dout, dw, db = conv_relu_pool_backward(dout, c0)
